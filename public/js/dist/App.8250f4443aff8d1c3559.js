...
function NewOrderPage(_ref) {
  ...
  function _handleAddToOrder() {
    _handleAddToOrder = _asyncToGenerator(function* (itemId) {
      const updatedCart = yield _utilities_orders_api__WEBPACK_IMPORTED_MODULE_5__.setItemQtyInCart(itemId, newQty);
      setCart(updatedCart);
    });
    return _handleAddToOrder.apply(this, arguments);
  }
...
/******/ })()
;
//# sourceMappingURL=App.44cbf5969883a4b363feada7d9776b00.js.map